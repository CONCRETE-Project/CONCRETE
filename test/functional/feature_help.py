...
"""Verify that starting concrete with -h works as expected."""
import subprocess

from test_framework.test_framework import ConcreteTestFramework
from test_framework.util import assert_equal

class HelpTest(ConcreteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start concrete with -h for help text")
        ...
        self.log.info("Start concrete with -version for version information")
