...
class RawTransactionsTest(ConcreteTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid concrete address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid concrete address" in e.error['message'])
