...
RESOURCES += src/qt/concrete.qrc src/qt/concrete_locale.qrc

TRANSLATIONS += src/qt/locale/concrete_bg.ts \
                src/qt/locale/concrete_de.ts \
                src/qt/locale/concrete_en.ts \
                src/qt/locale/concrete_es.ts \
                src/qt/locale/concrete_fi.ts \
                src/qt/locale/concrete_fr.ts \
                src/qt/locale/concrete_it.ts \
                src/qt/locale/concrete_ja.ts \
                src/qt/locale/concrete_pl.ts \
                src/qt/locale/concrete_pt.ts \
                src/qt/locale/concrete_ru.ts \
                src/qt/locale/concrete_sk.ts \
                src/qt/locale/concrete_sv.ts \
                src/qt/locale/concrete_vi.ts \
                src/qt/locale/concrete_zh_CN.ts \
                src/qt/locale/concrete_zh_TW.ts
