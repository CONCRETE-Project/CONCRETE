...
// Copyright (c) 2020-2020 The CONCRETE developers
...
#if defined(NDEBUG)
#error "CONCRETE cannot be compiled without assertions."
#endif
...
bool DisconnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool* pfClean)
{
    ...
    for (int i = block.vtx.size() - 1; i >= 0; i--) {
         ...
         * note we only undo zerocoin databasing in the following statement, value to and from CONCRETE
...
{
    util::ThreadRename("concrete-scriptch");
