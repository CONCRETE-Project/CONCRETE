...
#error Client version information missing: version is not defined by concrete-config.h or in any other way
#endif
...
/**
 * concreted-res.rc includes this file, but it cannot cope with real c++ code.
