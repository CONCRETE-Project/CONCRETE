...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CONCRETE Core concrete-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  concrete-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded concrete transaction") + "\n" +
                               "  concrete-tx [options] -create [commands]   " + _("Create hex-encoded concrete transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded concrete transaction
