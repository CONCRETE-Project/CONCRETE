...
#ifndef CONCRETE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CONCRETE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CONCRETE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
