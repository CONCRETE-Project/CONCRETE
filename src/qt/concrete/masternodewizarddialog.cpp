...
#include "qt/concrete/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/concrete/mnmodel.h"
...
bool MasterNodeWizardDialog::createMN()
{
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(GetCollateral()) * COIN, "");
