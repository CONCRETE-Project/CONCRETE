...
#include "qt/concrete/forms/ui_send.h"
#include "qt/concrete/addnewcontactdialog.h"
#include "qt/concrete/qtutils.h"
#include "qt/concrete/sendchangeaddressdialog.h"
    ...
    btnContacts(new QPushButton())
{
    ...
    /* Button Group */
    ui->pushLeft->setText("CCT");
    setCssProperty(ui->pushLeft, "btn-check-left");
    ui->pushLeft->setChecked(true);
    ui->pushRight->setText("zCCT");
    setCssProperty(ui->pushRight, "btn-check-right");

    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can transfer public coins (CCT) or private coins (zCCT)"));
    ...
    /* Address */
    ui->labelSubtitleAddress->setText(tr("CONCRETE address or contact label"));
    ...
    ui->labelAmountSend->setText("0.00 CCT");
