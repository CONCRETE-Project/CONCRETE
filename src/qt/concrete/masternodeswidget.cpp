...
#include "qt/concrete/forms/ui_masternodeswidget.h"

#include "qt/concrete/qtutils.h"
#include "qt/concrete/mnrow.h"
#include "qt/concrete/mninfodialog.h"
#include "qt/concrete/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/concrete/optionbutton.h"
...
MasterNodesWidget::MasterNodesWidget(CONCRETEGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:32812 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * GetCollateral())) {
        inform(tr("Not enough balance to create a masternode, 10,000 CCE required."));
        return;
    }
    showHideOp(true);
