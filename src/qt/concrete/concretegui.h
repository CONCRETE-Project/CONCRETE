...
#ifndef CONCRETE_CORE_NEW_GUI_CONCRETEGUI_H
#define CONCRETE_CORE_NEW_GUI_CONCRETEGUI_H
...
#include "qt/concrete/navmenuwidget.h"
#include "qt/concrete/topbar.h"
#include "qt/concrete/dashboardwidget.h"
#include "qt/concrete/send.h"
#include "qt/concrete/receivewidget.h"
#include "qt/concrete/addresseswidget.h"
#include "qt/concrete/privacywidget.h"
#include "qt/concrete/coldstakingwidget.h"
#include "qt/concrete/masternodeswidget.h"
...
/**
  CONCRETE GUI main class. This class represents the main window of the CONCRETE UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CONCRETEGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CONCRETEGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CONCRETEGUI();
...
#endif //CONCRETE_CORE_NEW_GUI_CONCRETEGUI_H
