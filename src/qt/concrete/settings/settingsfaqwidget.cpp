...
#include "qt/concrete/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/concrete/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(CONCRETEGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://CONCRETE.org/");
    ...
    if (parent)
        connect(parent, &CONCRETEGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
