...
#include "qt/concrete/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/concrete/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CONCRETEGUI* _window, QWidget *parent) :
