...
#include "qt/concrete/settings/settingssignmessagewidgets.h"
#include "qt/concrete/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(CONCRETEGUI* _window, QWidget *parent) :
