...
#include "qt/concrete/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/concrete/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CONCRETEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CONCRETEGUI::handleRestart()
