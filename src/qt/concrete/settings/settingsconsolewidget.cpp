...
#include "qt/concrete/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/concrete/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CONCRETEGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory){
    ...
    message(CMD_REPLY, (tr("Welcome to the CONCRETE RPC console.") + "<br>" +
