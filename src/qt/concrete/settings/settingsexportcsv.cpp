...
#include "qt/concrete/settings/settingsexportcsv.h"
#include "qt/concrete/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CONCRETEGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("CONCRETE_tx_csv_export(*.csv)") : tr("CONCRETE_addresses_csv_export(*.csv)"),
                                        nullptr);
