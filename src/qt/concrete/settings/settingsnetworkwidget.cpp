...
#include "qt/concrete/settings/settingsnetworkwidget.h"
#include "qt/concrete/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/concrete/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CONCRETEGUI* _window, QWidget *parent) :
