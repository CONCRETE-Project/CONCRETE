...
#include "qt/concrete/privacywidget.h"
#include "qt/concrete/forms/ui_privacywidget.h"
...
PrivacyWidget::PrivacyWidget(CONCRETEGUI* parent) :
    PWidget(parent),
    ui(new Ui::PrivacyWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("Minting zCCT anonymizes your CCT by removing any\ntransaction history, making transactions untraceable "));
    setCssSubtitleScreen(ui->labelSubtitle1);

    ui->labelSubtitle2->setText(tr("Mint new zCCT or convert back to CCT"));
    ...
    ui->lineEditAmount->setPlaceholderText("0.00 CCT ");
    ...
    ui->labelValueDenom1->setText("0x1 = 0 zCCT");
    ...
    ui->labelValueDenom5->setText("0x5 = 0 zCCT");
    ...
    ui->labelValueDenom10->setText("0x10 = 0 zCCT");
    ...
    ui->labelValueDenom50->setText("0x50 = 0 zCCT");
    ...
    ui->labelValueDenom100->setText("0x100 = 0 zCCT");
    ...
    ui->labelValueDenom500->setText("0x500 = 0 zCCT");
    ...
    ui->labelValueDenom1000->setText("0x1000 = 0 zCCT");
    ...
    ui->labelValueDenom5000->setText("0x5000 = 0 zCCT");
    setCssProperty(ui->labelValueDenom5000, "text-body2");

    ui->layoutDenom->setVisible(false);

    // List
    ui->labelListHistory->setText(tr("Last zCCT Movements"));
    ...
    ui->btnTotalzCCT->setTitleClassAndText("btn-title-grey", "Total 0 zCCT");
    ui->btnTotalzCCT->setSubTitleClassAndText("text-subtitle", "Show denominations of zCCT owned.");
    ui->btnTotalzCCT->setRightIconClass("ic-arrow");

    ui->btnCoinControl->setTitleClassAndText("btn-title-grey", "Coin Control");
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select CCT outputs to mint into zCCT.");
    ...
    ui->btnResetZerocoin->setTitleClassAndText("btn-title-grey", "Reset Spent zCCT");
