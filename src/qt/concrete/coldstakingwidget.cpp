...
#include "qt/concrete/forms/ui_coldstakingwidget.h"
#include "qt/concrete/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/concrete/requestdialog.h"
#include "qt/concrete/tooltipmenu.h"
#include "qt/concrete/furlistrow.h"
#include "qt/concrete/sendconfirmdialog.h"
#include "qt/concrete/addnewcontactdialog.h"
#include "qt/concrete/guitransactionsutils.h"
#include "walletmodel.h"
#include "optionsmodel.h"
#include "coincontroldialog.h"
#include "coincontrol.h"
#include "qt/concrete/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(CONCRETEGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your CCTs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept CCT delegation / Delegate CCT"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select CCT outputs to delegate.");
