...
#include "qt/concrete/forms/ui_topbar.h"
#include "qt/concrete/lockunlock.h"
#include "qt/concrete/qtutils.h"
#include "qt/concrete/receivedialog.h"
...
TopBar::TopBar(CONCRETEGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("CONCRETE")
    updateDisplayUnit();
