...
#include "qt/concrete/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CONCRETEGUI *parent, WalletModel* model) :
    QDialog(parent),
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CONCRETEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
