...
/** Utility functions used by the CONCRETE Qt UI.
 */
namespace GUIUtil
{
...
// Render CONCRETE addresses in monospace font
...
// Parse "concrete:" URI into recipient object, return true on successful parsing
