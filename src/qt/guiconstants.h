...
/* Concrete GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CONCRETE"
#define QAPP_ORG_DOMAIN "concrete.org"
#define QAPP_APP_NAME_DEFAULT "CONCRETE-Qt"
#define QAPP_APP_NAME_TESTNET "CONCRETE-Qt-testnet"
