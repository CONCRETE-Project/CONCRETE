...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > (Params().GetConsensus().nMaxMoneyOut / COIN) )
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop CONCRETE server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CONCRETE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CONCRETE features */
        {"concrete", "listmasternodes",             &listmasternodes,           true,  true,  false},
        {"concrete", "getmasternodecount",          &getmasternodecount,        true,  true,  false},
        {"concrete", "masternodeconnect",           &masternodeconnect,         true,  true,  false},
        {"concrete", "createmasternodebroadcast",   &createmasternodebroadcast, true,  true,  false},
        {"concrete", "decodemasternodebroadcast",   &decodemasternodebroadcast, true,  true,  false},
        {"concrete", "relaymasternodebroadcast",    &relaymasternodebroadcast,  true,  true,  false},
        {"concrete", "masternodecurrent",           &masternodecurrent,         true,  true,  false},
        {"concrete", "masternodedebug",             &masternodedebug,           true,  true,  false},
        {"concrete", "startmasternode",             &startmasternode,           true,  true,  false},
        {"concrete", "createmasternodekey",         &createmasternodekey,       true,  true,  false},
        {"concrete", "getmasternodeoutputs",        &getmasternodeoutputs,      true,  true,  false},
        {"concrete", "listmasternodeconf",          &listmasternodeconf,        true,  true,  false},
        {"concrete", "getmasternodestatus",         &getmasternodestatus,       true,  true,  false},
        {"concrete", "getmasternodewinners",        &getmasternodewinners,      true,  true,  false},
        {"concrete", "getmasternodescores",         &getmasternodescores,       true,  true,  false},
        {"concrete", "preparebudget",               &preparebudget,             true,  true,  false},
        {"concrete", "submitbudget",                &submitbudget,              true,  true,  false},
        {"concrete", "mnbudgetvote",                &mnbudgetvote,              true,  true,  false},
        {"concrete", "getbudgetvotes",              &getbudgetvotes,            true,  true,  false},
        {"concrete", "getnextsuperblock",           &getnextsuperblock,         true,  true,  false},
        {"concrete", "getbudgetprojection",         &getbudgetprojection,       true,  true,  false},
        {"concrete", "getbudgetinfo",               &getbudgetinfo,             true,  true,  false},
        {"concrete", "mnbudgetrawvote",             &mnbudgetrawvote,           true,  true,  false},
        {"concrete", "mnfinalbudget",               &mnfinalbudget,             true,  true,  false},
        {"concrete", "checkbudgets",                &checkbudgets,              true,  true,  false},
        {"concrete", "mnsync",                      &mnsync,                    true,  true,  false},
        {"concrete", "spork",                       &spork,                     true,  true,  false},
        ...
        {"zerocoin", "getzcctseed",                 &getzcctseed,               false, false, true },
        {"zerocoin", "setzcctseed",                 &setzcctseed,               false, false, true },
        {"zerocoin", "generatemintlist",            &generatemintlist,          false, false, true },
        {"zerocoin", "searchdzcct",                 &searchdzcct,               false, false, true },
        {"zerocoin", "dzcctstate",                  &dzcctstate,                false, false, true },
...
{
    return "> concrete-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32813/\n";
}
