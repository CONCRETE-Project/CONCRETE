Contributing to CONCRETE Core
============================

The CONCRETE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/concrete-project/concrete/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CONCRETE Core project, and is not to be
confused with overall CONCRETE Network Protocol consensus changes.

Whether a pull request is merged into CONCRETE Core rests with the project merge
...
Patches that change CONCRETE consensus rules are considerably more involved than
...
Where a patchset proposes to change the CONCRETE consensus, it must have been
...
The project leader is the release manager for each CONCRETE Core release.
