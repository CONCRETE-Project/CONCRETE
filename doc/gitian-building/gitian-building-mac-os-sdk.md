...
The script [extract-osx-sdk.sh](https://github.com/concrete-project/concrete/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
concrete/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/concrete-project/concrete/blob/master/doc/README_osx.md) for troubleshooting tips.