...
The build script we'll be using is contained in the CONCRETE github repository ([contrib/gitian-build.py](https://github.com/concrete-project/concrete/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the CONCRETE repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CONCRETE-Project/CONCRETE/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, concrete-detached-sigs, and concrete GitHub repos.
